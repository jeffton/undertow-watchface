...
class Bitmaps {
  ...
  var minutesLinearBackgroundBitmap as LazyBitmap = new LazyBitmap(Rez.Drawables.minutesLinearBackground);
  ...
  var weatherCloudsBitmap as LazyBitmap = new LazyBitmap(Rez.Drawables.weatherClouds);
